...
public class AppUpdateUtils {
    ...
    public static final String IGNORE_DATE_VERSION = "ignore_date_version";
    ...
    public static boolean isNeedIgnoreLetter(Context context, String newVersion) {
        return (getSP(context).getString(IGNORE_DATE_VERSION, "").equals(newVersion)) &&
                (getSP(context).getString(IGNORE_DATE, "").equals(getStringDateShort()));
    }

    public static void saveIgnoreDate(Context context, String newVersion) {
        getSP(context).edit().putString(IGNORE_DATE_VERSION, newVersion).apply();
        getSP(context).edit().putString(IGNORE_DATE, getStringDateShort()).apply();
