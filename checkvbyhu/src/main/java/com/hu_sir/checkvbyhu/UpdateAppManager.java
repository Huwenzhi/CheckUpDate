...
import com.hu_sir.checkvbyhu.bean.UpdateAppBean;
import com.hu_sir.checkvbyhu.listener.ExceptionHandler;
import com.hu_sir.checkvbyhu.listener.ExceptionHandlerHelper;
import com.hu_sir.checkvbyhu.listener.HttpManager;
import com.hu_sir.checkvbyhu.listener.IUpdateDialogFragmentListener;
import com.hu_sir.checkvbyhu.listener.SilenceUpdateCallback;
import com.hu_sir.checkvbyhu.listener.UpdateCallback;
import com.hu_sir.checkvbyhu.service.DownloadService;
import com.hu_sir.checkvbyhu.ui.UpdateDialogFragment;
import com.hu_sir.checkvbyhu.util.AppUpdateUtils;
import com.hu_sir.checkvbyhu.util.UpdateAppHttpUtil;
...
public class UpdateAppManager {
    ...
    private UpdateAppManager(Builder builder) {
        ...
        mShowCanLetter = builder.isCanLetter();
...
//    }
    ...
    public UpdateAppBean fillUpdateAppData() {
        if (mUpdateApp != null) {
            ...
            mUpdateApp.showCanLetter(mShowCanLetter);
    ...
    private boolean verify() {
        ...
        if (mShowCanLetter && AppUpdateUtils.isNeedIgnoreLetter(mActivity, mUpdateApp.getNewVersion())) {
            return true;
        }
...
//                || !mTargetPath.startsWith(preSuffix)
     ...
     * 跳转到更新页面
     */
    public void showDialogFragment(UpdateAppBean updateAppBean) {
    ...
    public static class Builder {
        ...
        public boolean isCanLetter() {
            return mCanLetter;
        }

        public Builder showCanLetter() {
            mCanLetter = true;
            return this;
        }
         ...
         * @return 生成app管理器
         */
        public UpdateAppManager buildDownOnly() {
            //校验
            if (getActivity() == null) {
                throw new NullPointerException("必要参数不能为空");
            }
