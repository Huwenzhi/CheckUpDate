package com.hu_sir.checkvbyhu.ui;
...
import com.hu_sir.checkvbyhu.R;
import com.hu_sir.checkvbyhu.UpdateAppManager;
...
import com.hu_sir.checkvbyhu.util.ColorUtil;
import com.hu_sir.checkvbyhu.util.DrawableUtil;
...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private TextView mIgnore, mLetter;
...
//                        startActivity(new Intent(Intent.ACTION_MAIN).addCategory(Intent.CATEGORY_HOME));
    ...
    private void initView(View view) {
        ...
        //letter 稍后提醒
        mLetter = view.findViewById(R.id.tv_letter);
    ...
    private void initData() {
        ...
        if (mUpdateApp != null) {
            ...
            //标题
            mTitleTextView.setText(TextUtils.isEmpty(dialogTitle) ? String.format("是否升级到%s版本？", TextUtils.isEmpty(newVersion) ? "" : newVersion) : dialogTitle);
            //强制更新
            if (mUpdateApp.isConstraint()) {
                ...
                if (mUpdateApp.ismShowCanLetter()){
...
//            }
            ...
            AppUpdateUtils.saveIgnoreDate(getActivity(),mUpdateApp.getNewVersion());
            dismiss();
        }
    }
