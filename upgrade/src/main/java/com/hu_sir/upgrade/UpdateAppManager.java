...
import com.hu_sir.upgrade.listener.ExceptionHandlerHelper;
...
//                || !mTargetPath.startsWith(preSuffix)
    ...
    private void processData(String result, @NonNull UpdateCallback callback) {
        try {
            ...
            if (TextUtils.equals(AppUpdateUtils.getVersionName(mActivity),mUpdateApp.getVersion())&&AppUpdateUtils.getVersionCode(mActivity)==Integer.valueOf(mUpdateApp.getCode())){
                mUpdateApp.setUpdate("No");
            }else {
